...
/**
 * Created by Sarthak on 7/25/2016.
 */
public class LoginFormAuthenticator extends LoginAuthenticator {
  ...
  public LoginFormAuthenticator() {
  }

  /* ------------------------------------------------------------ */
  public LoginFormAuthenticator(String login, String error, boolean dispatch) {
    this();
    if (login != null)
      setLoginPage(login);
    if (error != null)
    ...
    try {
      ...
      if (isJSecurityCheck(uri)) {
        ...
        if (user != null) {
          ...
          String nuri;
          LoginFormAuthenticator.FormAuthentication form_auth;
      ...
      synchronized (session) {
        ...
        if (session.getAttribute(__J_URI) == null || _alwaysSaveUri) {
          ...
          if (!urlPath.contains("index.html")) {
            urlPath = urlPath.replace(".html", "");
            urlPath = urlPath.replace("/html/", "/html/index.html/#");
          }
